                            ...
                            itemBuilder: (context, index) {
                              return Padding(
                                ...
                                child: GestureDetector(
                                  onTap: () => controller.clickOnRealCheckItem(
                                      index: index),
                                  child: Row(
                                    children: [
                                      Container(
                          ...
                          ListView.builder(
                            ...
                            itemBuilder: (context, index) {
                              return Padding(
                                ...
                                child: GestureDetector(
                                  onTap: () => controller
                                      .clickOnClassificationItem(index: index),
                                  child: Row(
                                    children: [
                                      Container(
                                        height: 16.px,
          ...
          children: [
            ...
            TextField(
              ...
              decoration: InputDecoration(
                  ...
                  hintStyle: Theme.of(Get.context!).textTheme.headlineSmall,
