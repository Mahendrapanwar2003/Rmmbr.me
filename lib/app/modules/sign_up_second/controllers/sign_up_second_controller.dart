      ...
      if (!acceptTermsOfUseValue.value) {
        if (createPasswordController.text.trim() ==
          ...
          Map<String, dynamic> bodyParams = {
            ...
            ApiKeyConstants.fullName: fullName,
            ApiKeyConstants.phone: phone,
            ApiKeyConstants.dob: dob,
            ApiKeyConstants.gender: gender,
            ApiKeyConstants.countryCode: countryCode,
            ...
            ApiKeyConstants.password: createPasswordController.text,
          };
